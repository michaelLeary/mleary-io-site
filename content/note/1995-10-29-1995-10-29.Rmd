...
```{r fig-fullwidth, fig.width = 10, fig.height = 2, fig.fullwidth = TRUE, fig.cap = "Hang Lung group schema", cache=TRUE, message=FALSE}
knitr::include_graphics("/Users/michaelleary/Documents/GitHub/analyst_diary/data/hanglungmindmap.jpg")
```
