...
library(fredr)
library(here)
pkgs = c("dplyr", "ggplot2", "tidyverse", "purrr", "xts", "httr", "scales", "ggpubr", "gridExtra", "knitcitations", "RefManageR", "showtext", "data.table", "lubridate", "R.filesets") 
...
```{r copperplot, fig.width = 10, echo=FALSE, warning=FALSE, include=FALSE}
