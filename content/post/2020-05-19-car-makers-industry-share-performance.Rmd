...
```{r, include = FALSE}
symbol <- c("7269.T", "7203.T", "7267.T", "7201.T", "F", "GM", "FCA.MI", "VOW.DE", "DAI.DE", "BMW.DE", "UG.PA", "0175.HK", "0489.HK", "600104.SS", "MARUTI.BO", "TATAMOTORS.NS", "^DJI", "^GSPC", "^BSESN")
company <- c("Suzuki", "Toyota","Honda","Nissan", "Ford", "GM", "Fiat", "VW", "Daimler", "BMW","Peugeot","Geely", "Dongfeng", "SAIC", "Maruti", "Tata", "Dow Jones Industrial Average", "S&P 500 Index", "Bombay Stock Exchange")
