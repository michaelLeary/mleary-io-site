...
Expected to be sourced from Wikipedia and Wikimedia commons and comprise open source user produced data that is freely shareable. 
...
* Seal svg creator: [Furfur](https://fr.m.wikivoyage.org/wiki/Fichier:Seal_of_Uttar_Pradesh.svg).
...
> depicts the confluence of the Ganges and Yamuna rivers at Prayagraj, a pair of Matsya fish to represent the former hindu and muslim rulers of Oudg, and, a bow and arrow to represent the hindu deity Rama who was born in Ayodhya within the state.

## 2. State districts 

* Original file size: 4000x2600 pixels and 457KB

* Seal svg creator: [BishkekRocks](https://commons.wikimedia.org/wiki/File:List_of_districts_of_Uttar_Pradesh_(2012).svg).
...
knitr::kable(updistorder[,c(2:7)], "html",
             caption = "Uttar Pradesh districts as of 2012",
             booktabs = TRUE,
             longtable = FALSE ) %>%
...
* The most recent election result of 2019 gave 303 seats of 545 to BJP. 

* Next Lok Sabhya elections will be in 2024. 
...
* Vidhan Sabha constituencies and elected members as of 2017^[Source: https://en.wikipedia.org/wiki/Seventeenth_Legislative_Assembly_of_Uttar_Pradesh]
...
knitr::kable(uplower_df[,c(2,3,6)], "html",
...
* data source: [Chief Electoral Officer, Uttar Pradesh](http://ceouttarpradesh.nic.in/images/u2.pdf)
