---
title: Remap factor levels
author: michael
date: '2020-06-02'
slug: remap-factor-levels-column-add-reorder-df
categories:
  - R
tags:
  - Tools
...
Further to data extract of human muscle group from [Wikipedia](https://en.wikipedia.org/wiki/List_of_skeletal_muscles_of_the_human_body) the goal here was to remap the factor levels in the variable source. The intention is to shrink down the number of categories from 48 to 5 to simplify understanding of statistics to be performed on muscle groups in future. 

To achieve that the source variable in the data frame was converted to factor type. It was then duplicated. A fresh factor variable that mapped the levels from the duplicated source variable was created and is labelled x. 


```{r packages, include=FALSE}
pkgs = c("rvest", "tidyverse", "janitor", "lubridate", "dplyr", "kableExtra", "data.table", "forcats", "plyr") 
...
```{r datevars, eval=FALSE, include=FALSE}
...
# convert the source to a factor variable
bodywhole3$source <- as.factor(bodywhole3$source)
...
# row numbers added 
z1 <- tibble::rowid_to_column(z, "ID")

# a duplicate column of source variable added 

z1$source2 <- z1$source

# the data frame was reordered to place duplicated row 

z2 <- z1[, c(1,10, 2, 3,4,5,6,7,8,9)]
```


```{r, include=FALSE}
# then using revalue command the factor levels were changed

z3 <- mutate(z2, x = revalue(source2,
                             c(
"forehead" = "head", 
"extraocular" = "head",
"ear" = "head",
...
"mouth" = "head",
"mastication" = "head",
"tongueextrinsic" = "head",
"tongueintrinsic" = "head",
"softpalate" = "head",
"pharynx" = "head",
"larynx" = "head", 
"neck.clavicular" = "neck", 
"neck.suprahyoid" = "neck", 
...
"pelvis" = "torso", 
"perineum" = "torso", 
"upperlimb.vertebralcol" = "upper", 
"upperlimb.thoracicwall" = "upper", 
"upperlimb.shoulder" = "upper", 
"upperlimbarmanterior.arm" = "upper", 
"upperlimbarmposterior.arm" = "upper", 
"forearmanteriorcompartment.superficial" = "upper", 
"forearmanteriorcompartment.deep" = "upper", 
"forearmposteriorcompartment.superficial" = "upper", 
"forearmposteriorcompartment.deep" = "upper", 
"handlateralcolarthenar" = "upper", 
"handmedialvolar" = "upper", 
"handintermediate" = "upper", 
"loweriliac" = "lower", 
"lowergluteal" = "lower", 
"thighanteriorcompartment" = "lower", 
"thighposteriorcompartment" = "lower", 
"thighmedialcompartment" = "lower", 
"leganteriorcompartment" = "lower", 
"legposteriorcompartmentsuperficial" = "lower", 
"legposteriorcompartmentdeep" = "lower", 
"leglateralcompartmentdeep" = "lower", 
"footdorsal" = "lower", 
"footplantarfirstlayer" = "lower", 
"footplantarsecondlayer" = "lower", 
"footplantarthirdlayer" = "lower", 
"footplantarfourthlayer" = "lower")
))

```

```{r, include=FALSE}
# remapped variable factor reordered

# reorder columns and place regrouped factor up front
z4 <- z3[, c(1,11, 2, 3,4,5,6,7,8,9,10)]

# drop source2 duplicate factor
z4 <- z4[,-3]
