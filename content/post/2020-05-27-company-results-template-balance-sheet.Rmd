---
title: 'Company results template: balance sheet'
author: Michael
date: '2020-05-27'
slug: 'Company results template: balance sheet'
categories:
  - R
tags:
  - Finance
...
Even though there was a draw down of cash during the year Suzuki's balance sheet remains strong with ending net cash and securities of JPY1677 billion or US$15 billion equivalent to JPY3,579/share. 

In light of ongoing uncertainties in the durability of future demand management has flagged that it intends to continue to strengthen the balance sheet. 

```{r balancehseet, echo=FALSE}
#subset out the rows needed and then transpose
debtnos <- fs.yoy[c(34:36,8,37),]
debtnos
```
