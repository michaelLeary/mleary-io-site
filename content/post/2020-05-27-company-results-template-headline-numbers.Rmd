---
title: 'Company results template: headline numbers'
author: Michael
date: '2020-05-27'
slug: company-results-template-headline-numbers
categories:
  - R
tags:
  - Finance
...
Suzuki announced a 10% reduction in net sales for the year to JPY `r round(fs.yoy[1,2]/1000)` billion or US\$32.4 billion. Operating income fell 34% to JPY `r round(fs.yoy[2,2]/1000)` billion or US\$2 billion. Earnings per share declined 28% to JPY286/share. Despite the reported decline registered and further weakness projected ahead the company balance sheet remains strong and management declared a special dividend. 

```{r headlinenos, echo=FALSE}
#subset out the rows needed and then transpose
headnos <- fs.yoy[c(1:4, 26:28),]
headnos
```
